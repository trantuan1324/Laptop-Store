                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-6 col-12 mx-auto">
                            <h1 class="label">Update product's information</h1>
                            <hr>
                            <%--@elvariable id="currentProduct" type="com.rabbyte.LaptopStore.domain.Product"--%>
                            <form:form method="post" enctype="multipart/form-data" action="/admin/products/update" modelAttribute="currentProduct" class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <img style="max-height: 250px; display: block;" alt="chosen avatar" id="currentAvatar" src="http://localhost:8080/images/product/${currentProduct.image}"/>
                                </div>
                                <div class="col-12">
