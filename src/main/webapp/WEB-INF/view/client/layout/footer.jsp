        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p>Email: tranqt.work@gmail.com</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light"><a href="https://github.com/trantuan1324"><i class="fas fa-copyright text-light me-2"></i>Rabbyte</a>, All right reserved.</span>
            </div>
